...
- Each vote must open a “Text and Vote Details” screen that keeps official sources separate from external resources, explains the exact effect of Pour/Contre/Abstention/Non-votant in the context of the subject type, and shows clean empty states for parent text, amendment/article/motion details, group comparison, and external resources when not available.
