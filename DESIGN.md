...
- CitizenEye is French-only: every user-facing title, label, empty state, error message, explanation, CTA, detail-screen string, public-site text and release note must be in French.
